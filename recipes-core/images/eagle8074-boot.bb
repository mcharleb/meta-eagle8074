...
DEPENDS += "eagle8074-kernel dtc-native android-tools-native"
...
do_install() {
    mkbootimg --kernel ${STAGING_DIR_TARGET}boot/${MACHINE}/zImage \
	--dt ${STAGING_DIR_TARGET}/boot/${MACHINE}/devicetree.img \
	--base ${KERNEL_BASE} \
